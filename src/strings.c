...
const u8 gText_Tm13_4000Coins[] = _("CYNDAQUIL{CLEAR_TO 0x48}{SMALL}5,000 COINS");
const u8 gText_Tm23_3500Coins[] = _("CHIKORITA{CLEAR_TO 0x48}{SMALL}5,000 COINS");
const u8 gText_Tm24_4000Coins[] = _("TOTODILE{CLEAR_TO 0x48}{SMALL}5,000 COINS");
const u8 gText_Tm30_4500Coins[] = _("SKARMORY{CLEAR_TO 0x48}{SMALL}7,500 COINS");
const u8 gText_Tm35_4000Coins[] = _("LARVITAR{CLEAR_TO 0x48}{SMALL}9999 COINS");
...
const u8 gText_Eevee[] = _("CERULEAN MENACE");
const u8 gText_Flareon[] = _("MOUNT EMBER MONSTER");
const u8 gText_Jolteon[] = _("POWER PLANT MENACE");
const u8 gText_Vaporeon[] = _("SEAFOAM ISLAND MYSTERY");
...
const u8 gText_Abra_180Coins[] = _("RALTS{CLEAR_TO 0x55}{SMALL} 180 COINS");
const u8 gText_Clefairy_500Coins[] = _("MAWILE{CLEAR_TO 0x55}{SMALL} 500 COINS");
const u8 gText_Dratini_2800Coins[] = _("BAGON{CLEAR_TO 0x4B}{SMALL} 2,800 COINS");
const u8 gText_Scyther_5500Coins[] = _("SABLEYE{CLEAR_TO 0x4B}{SMALL} 5,500 COINS");
const u8 gText_Porygon_9999Coins[] = _("BELDUM{CLEAR_TO 0x4B}{SMALL} 9,999 COINS");
const u8 gText_Abra_120Coins[] = _("ABRA{CLEAR_TO 0x55}{SMALL} 120 COINS");
const u8 gText_Clefairy_750Coins[] = _("MAWILE{CLEAR_TO 0x55}{SMALL} 750 COINS");
